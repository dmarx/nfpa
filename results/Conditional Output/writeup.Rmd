...
detailed_output = FALSE # This will turn off large text blocks
...
simple_output = !detailed_output

```

```{r setup, cache=FALSE, include=FALSE}
# via: http://stackoverflow.com/a/25252286/819544
library(knitr)
output <- opts_knit$get("rmarkdown.pandoc.to")
#if (output=="html") opts_chunk$set(fig.width=11, fig.height=11)
#if (output=="docx") opts_chunk$set(fig.width=6,  fig.height=6)

### What I want to do is optionally set section numbering and TOC only if output is docx

##>> Advanced styling: use a reference document: http://rmarkdown.rstudio.com/articles_docx.html
## Q: Can I set TOC output and section numbering from inside the reference template? Or do I need to set `toc: TRUE` and cross my fingers?
```


## Executive Summary

```{python b1, echo=FALSE, results='asis', eval=detailed_output}
print("""
...
```{python b2, echo=FALSE, results='asis', eval=detailed_output}
print("""
...
```{python b3, echo=FALSE, results='asis', eval=detailed_output}
print("""It is unknown what year these results are from, but it is assumed they are all from the same year. Additionally, Part II, Question 5 asks:
...
```{r gvis, echo=FALSE, message=FALSE, warning=FALSE, eval=simple_output}
library(googleVis)
library(shiny)
...
```{python b4, echo=FALSE, results='asis', eval=detailed_output}
print("""
...
```{python b5a, echo=FALSE, results='asis', eval=detailed_output}
print("""## Stability of staffing levels
...
```{python b5b, echo=FALSE, results='asis', eval=detailed_output}
print("""
...
```{python b5c, echo=FALSE, results='asis', eval=detailed_output}
print("""
The following chart provides the empirical distribution function for the absolute value of the net percent change for each department relative to their 2011 paid staffing.
""")
```

```{python b5d, echo=FALSE, results='asis', eval=simple_output}
print("""## Stability of staffing levels
""")
```
...
```{python b5, echo=FALSE, results='asis', eval=detailed_output}
print("""## Representation of Women
...
```{python b6a, echo=FALSE, results='asis', eval=simple_output}
print("""## Representation of Women""")
```
...
```{python b6, echo=FALSE, results='asis', eval=detailed_output}
print("""
...
```{python, echo=FALSE, results='asis', eval=simple_output}
print("""## Representation of Women""")
```
...
```{python b7, echo=FALSE, results='asis', eval=detailed_output}
...
gg <- ggplot(roc_df, aes(xv, yv)) + 
  ...
  labs(x="False Positive Rate",
       ...
       title=paste0("Logistic Regression Performance: ROC curve")
       )
...
```{python b8, echo=FALSE, results='asis', eval=detailed_output}
print("""
