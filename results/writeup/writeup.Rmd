...
52% of departments have no full-time paid personnel. Of the departments that do employ full time paid personnel, 99% of departments are within 2% of paid staffing levels from 2011. 

The following chart provides the empirical distribution function for the absolute value of the net percent change for each department relative to their 2011 paid staffing. The highest observed for any department was an 11% change
