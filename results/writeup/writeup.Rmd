...
* 99% of departments that staff paid personnel have experienced less than 2% net personnel change since 2011
* Over 46% of stations are running apparatus that is 15+ years old
...
1. Count the maximum number of characters for any value in the column.
...
gg <- ggplot(survey_dt[q6>0], 
        ...
        labs(x="Absolute % Personnel Change (Paid)",
             ...
             title="Percent Change Paid FFs since 2011"
             )
